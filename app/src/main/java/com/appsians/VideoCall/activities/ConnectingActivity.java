...
import com.appsians.VideoCall.databinding.ActivityConnectingBinding;
...
//                                    continue;
    ...
    protected void onDestroy() {
        super.onDestroy();
        if(database.getReference().child("users") != null)
            if(database.getReference().child("users").child(username) != null)
                database.getReference()
                .child("users")
                .child(username)
                .removeValue();

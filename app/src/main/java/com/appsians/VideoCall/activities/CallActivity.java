...
import com.appsians.VideoCall.databinding.ActivityCallBinding;
import com.appsians.VideoCall.models.InterfaceJava;
...
public class CallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.videoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Show/Don't show user's video feed
                isVideo = !isVideo;
    ...
    void listenConnId() {
        firebaseRef.child(friendsUsername)
                    .child("connId")
